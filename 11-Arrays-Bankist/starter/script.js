...
const calcAverageHumanAge = function (dogAge) {
  ...
  let averageHumanAge = adults.reduce(
...
///////////////////////////////////////
// Find Method
const firstWithdrawal = movements.find(mov => mov < 0); //finds first match
console.log(movements);
...
console.log(arr.flat()); //only 1 level deep

const arrDeep = [[[1, 2], 3], [4, [5, 6]], 7, 8];
console.log(arrDeep.flat(2)); //Has a depth argument

//Get an overall account balance
//Flat: Multiple levels
...
//Can use fill
x.fill(1, 3, 5); //mutates the array
x.fill(1);
console.log(x);
...
//1. Add up all deposits accross accounts
const bankDepositSum = accounts
  .flatMap(acc => acc.movements)
  .filter(mov => mov > 0)
  .reduce((cum, mov) => cum + mov, 0);

console.log(bankDepositSum);

//2. Count deposits with at least $1K
//With reduce
...
//3. Create a new object with sum of the deposits and withdrawals
...
console.log(dogs.some(justRight));

//7.
const okayDogs = dogs.filter(justRight);
