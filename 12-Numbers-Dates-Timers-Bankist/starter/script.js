...
console.log(64646546987986513231646435n);
console.log(BigInt(64646546));

//Operations
console.log(10000n + 10000n);
console.log(321356464644n * 6543645987n);
// console.log(Math.sqrt(16n));//wont work

const huge = 1656546543121646876131n;
const num = 23;
...
// console.log(new Date('Mon Oct 11 2021 16:06:14'));
