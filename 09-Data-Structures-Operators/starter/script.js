...
console.log('Cardy Moten'.split(' '));

const [firstName, lastName] = 'Cardy Moten'.split(' ');
...
capitalizeName('cardy moten');

//Padding
const message = 'Go to gate 23!';
console.log(message.padStart(25, '+').padEnd(30, '+'));
console.log('Cardy'.padStart(20, '+').padEnd(30, '+'));
...
console.log(maskCreditCard(23457836));
console.log(maskCreditCard(12345678987464));
console.log(maskCreditCard('316456468432174481'));
...
const passenger = 'cArDY'; //Cardy

const passengerProper = function (name) {
  const nameLower = name.toLowerCase();
  const nameCorrect = nameLower[0].toUpperCase() + nameLower.slice(1);
  return nameCorrect;
};

console.log(passengerProper(passenger));

//Comparing emails
const email = 'hello@cardy.io';
const loginEmail = '  Hello@Cardy.Io \n';

const normalizedEmail = function (email) {
  return email.toLowerCase().trim();
};
const checkEmail = function (email1, email2) {
  return normalizedEmail(email1) === normalizedEmail(email2);
};

console.log(checkEmail(email, loginEmail));
...
//Slice syntax
//slice(beginIndex)
//slice(beginIndex, endIndex) end not included
...
console.log(new String('cardy'));
console.log(typeof new String('cardy'));
console.log(typeof new String('cardy').slice(1));
...
const res = question.get(answer === question.get('correct'));
...
console.log(new Set('cardymoten').size);
